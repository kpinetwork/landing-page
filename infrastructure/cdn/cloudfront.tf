...
resource "aws_cloudfront_distribution" "landing_distribution" {
  origin {
    ...
    domain_name = var.landing_bucket.bucket_regional_domain_name
    s3_origin_config {
      origin_access_identity = aws_cloudfront_origin_access_identity.landing_web_distribution.cloudfront_access_identity_path
    }
  }
...
resource "aws_cloudfront_origin_access_identity" "landing_web_distribution" {
